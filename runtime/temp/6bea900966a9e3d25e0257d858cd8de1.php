<?php /*a:1:{s:69:"D:\phpstudy\phpstudy_pro\WWW\xxjsdati.com\app\view\teacher\index.html";i:1781065604;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>教师端 - 信息技术课刷题考试系统</title>
    <style>
...
<body>
    <div class="header">
        ...
        <div class="nav">
            <a href="/teacher" class="active">首页</a>
    ...
    <div class="main-content">
        <div class="stats-grid">
            <div class="stat-card">
                <div class="value"><?php echo htmlentities((string) $courseCount); ?></div>
                <div class="label">授课课程</div>
            </div>
            <div class="stat-card">
                <div class="value"><?php echo htmlentities((string) $classCount); ?></div>
                <div class="label">管理班级</div>
            </div>
            <div class="stat-card">
                <div class="value"><?php echo htmlentities((string) $studentCount); ?></div>
                <div class="label">学生总数</div>
            </div>
            <div class="stat-card">
                <div class="value"><?php echo htmlentities((string) $taskCount); ?></div>
        ...
        <div class="section">
            ...
            <div class="class-list">
                ...
                <div class="class-card">
                    ...
                    <p>年级：<?php echo htmlentities((string) (isset($class['grade']) && ($class['grade'] !== '')?$class['grade']:'-')); ?></p>
                    <p>专业：<?php echo htmlentities((string) (isset($class['major']) && ($class['major'] !== '')?$class['major']:'-')); ?></p>
                    <p><?php echo htmlentities((string) (isset($class['description']) && ($class['description'] !== '')?$class['description']:'-')); ?></p>
                </div>
                <?php endforeach; endif; else: echo "" ;endif; if(empty($classes) || (($classes instanceof \think\Collection || $classes instanceof \think\Paginator ) && $classes->isEmpty())): ?>
                <p style="text-align: center; color: #999;">暂无班级</p>
                <?php endif; ?>
            </div>
        </div>
    </div>

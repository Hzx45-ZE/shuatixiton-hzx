<?php /*a:1:{s:68:"D:\phpstudy\phpstudy_pro\WWW\xxjsdati.com\app\view\student\exam.html";i:1781091753;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>模拟考试 - 信息技术课刷题考试系统</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .paper-card .btn:hover { background: #5a6fd6; }
        .paper-card .btn.completed { background: #52c41a; }
        .btn-row-mini { display: flex; gap: 8px; margin-top: 8px; }
        .btn-row-mini .btn { flex: 1; }
        .btn-row-mini .btn:hover { background: #45a614; }
...
<body>
    <div class="header">
        ...
        <div class="nav">
            ...
            <a href="/student/exam" class="active">模拟考试</a>
            ...
            <div class="paper-list">
                ...
                <div class="paper-card">
                    ...
                    <div class="btn-row-mini">
                        <button class="btn outline" onclick="location.href='/student/exam/detail?record_id=<?php echo htmlentities((string) $paper['record_id']); ?>'">查看详情</button>
                        <button class="btn completed" onclick="startExam(<?php echo htmlentities((string) $paper['id']); ?>, true)">再次考试</button>
                    </div>
                    <?php else: ?>
                    <button class="btn" onclick="startExam(<?php echo htmlentities((string) $paper['id']); ?>, false)">开始考试</button>
                    <?php endif; ?>
                </div>
    ...
    <script>
        function startExam(paperId, isCompleted) {
            if (isCompleted) {
                if (!confirm('确定要再次参加考试吗？之前成绩不会被覆盖。')) {
                    return;
                }
            }
            location.href = `/student/exam/start?paper_id=${paperId}`;
        }
    </script>
</body>
</html>
<?php /*a:1:{s:70:"D:\phpstudy\phpstudy_pro\WWW\xxjsdati.com\app\view\student\course.html";i:1781065604;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>课程学习 - 信息技术课刷题考试系统</title>
    <style>
...
<body>
    <div class="header">
        ...
        <div class="nav">
            <a href="/student">首页</a>
            <a href="/student/courses" class="active">课程学习</a>
    ...
    <div class="main-content">
        ...
        <div class="course-grid">
            ...
            <div class="course-card" onclick="location.href='/student/courses/detail?id=<?php echo htmlentities((string) $course['id']); ?>'">
                <div class="cover">📖</div>
                <h3><?php echo htmlentities((string) $course['name']); ?></h3>
                <p><?php echo htmlentities((string) (isset($course['description']) && ($course['description'] !== '')?$course['description']:'暂无描述')); ?></p>
                <div class="meta">
                    <span>授课教师：<?php echo htmlentities((string) (isset($course['teacher']['real_name']) && ($course['teacher']['real_name'] !== '')?$course['teacher']['real_name']:'未分配')); ?></span>
                </div>
            </div>
